...
- `[~]` Chapter 3 curated import and stat-sheet foundation
  ...
  Next step: run the manual review/publish pass for Chapter 3, then decide whether to continue Codex chapter imports or return focus to Session Ops cleanup.
